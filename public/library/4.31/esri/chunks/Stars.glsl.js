...
new n.FloatPassUniform("pixelRatio",(g,c)=>c.camera.pixelRatio));a.vertex.main.add(k.glsl`gl_Position = transform * vec4(position, 0);
vcolor = color / 1.2;
vsize = size * 5.0 * pixelRatio;
gl_PointSize = vsize;`);a.fragment.main.add(k.glsl`float cap = 0.7;
float scale = 1.0 / cap;
...
fragColor = vec4(vcolor.xyz, intensity);`);return a}const b=e.create();e=Object.freeze(Object.defineProperty({__proto__:null,build:l},Symbol.toStringTag,{value:"Module"}));h.Stars=e;h.build=l});
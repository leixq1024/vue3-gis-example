...
(d,b)=>b.shadowMap.depthTexture),new p.IntegerPassUniform("numCascades",(d,b)=>b.shadowMap.numCascades),new n.Float4PassUniform("cascadeDistances",(d,b)=>b.shadowMap.cascadeDistances)).code.add(e.glsl`int chooseCascade(float depth, out mat4 mat) {
